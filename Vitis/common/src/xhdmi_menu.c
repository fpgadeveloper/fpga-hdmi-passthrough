...
void XHdmi_DisplayMainMenu(void)
{
	...
	xil_printf("t - Dump TMDS181 Registers\r\n");
	xil_printf("u - Dump 8T49N241 Registers\r\n");
	xil_printf("w - Initialize 8T49N241\r\n");
#endif
...
static XHdmi_MenuType XHdmi_MainMenu(XHdmi_Menu *InstancePtr, u8 Input) {
	...
	switch (Input) {
		...
		case ('u') :
		case ('U') :
			IDT_8T49N24x_RegisterDump(XPAR_IIC_0_BASEADDR, I2C_CLK_ADDR);
			break;
